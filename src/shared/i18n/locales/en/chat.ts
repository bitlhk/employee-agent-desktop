export default {
  ...
  reasoningEffort: {
    ...
    hint: "Controls how much effort the model spends on reasoning before responding.",
    saveError: "Failed to save reasoning effort setting.",
    auto: "Auto",
    autoDescription: "Let the model decide based on the task.",
    minimal: "Minimal",
    minimalDescription: "Fastest response, minimal reasoning.",
    low: "Low",
    lowDescription: "Light reasoning for simple tasks.",
    medium: "Medium",
    mediumDescription: "Balanced speed and depth.",
    high: "High",
    highDescription: "Deeper reasoning for complex tasks.",
    xhigh: "Max",
    xhighDescription: "Maximum reasoning effort, slowest response.",
  },
} as const;
