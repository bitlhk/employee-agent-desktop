export default {
  ...
  qqClientSecret: "QQ Client Secret",
  qqClientSecretHint: "QQ Open Platform bot client secret",
  qqAllowedUsers: "Allowed QQ Users",
  qqAllowedUsersHint: "Comma-separated QQ users allowed to use the bot",
  ...
  platformQqBotDesc: "Connect to a QQ Bot from the QQ Open Platform",
