export default {
  ...
  reasoningEffort: {
    title: "推理强度",
    hint: "控制模型在响应前花费多少精力进行推理。",
    saveError: "保存推理强度设置失败。",
    auto: "自动",
    autoDescription: "由模型根据任务自动决定。",
    minimal: "极简",
    minimalDescription: "最快响应，最少推理。",
    low: "低",
    lowDescription: "简单任务的轻量推理。",
    medium: "中",
    mediumDescription: "速度与深度的平衡。",
    high: "高",
    highDescription: "复杂任务的深度推理。",
    xhigh: "极高",
    xhighDescription: "最大推理强度，响应最慢。",
  },
} as const;
